...
public class WorstFit extends MemoryManager {
	...
	/*
	 * Constructor baut den Speicher, hier: int array [cell] in der größe size
	 * [1024] mit dem Eintrag "-1" -> frei kommt ein prozess, wird die ID in die
	 * cell geschrieben Aktuallisierungen werden iterativ über dem gesammten
	 * Speicher gemacht. (soll ja nicht schnell sein)
	 */
	 ...
	 *
	 * Id Name Size start EndPos 0 p1 100 0 99 1 p2 500 100 599 .....
	 */
	@Override
